...
public class SOSGeneralGame extends SOSGameBase {
    ...
    public void makeAutoMove() {
        ...
        if (!isGameOver()) {
            ...
            // In computer vs computer mode, trigger the next move if the game is still ongoing
            if (isComputerVsComputer) {
                SwingUtilities.invokeLater(this::makeAutoMove);
            }
        }
    }
