...
public class SosGUI extends JFrame {
 ...
 // Update turn display
    ...
    private void startRecording() {
        isRecording = true;
        // Reset the game state or any other necessary steps before starting recording
        restartGame();
    }
    ...
    private void updateGuiWithMove(SOSGameBase.GameMove move) {
        ...
        // Update scores and turns if necessary
        scoreLabel.setText("Blue: " + game.getScore('S') + " | Red: " + game.getScore('O'));
        turnLabel.setText("Turn: " + (game.getTurn() == 'S' ? "Blue" : "Red"));
        turnLabel.setForeground(game.getTurn() == 'S' ? Color.BLUE : Color.RED);
    }
